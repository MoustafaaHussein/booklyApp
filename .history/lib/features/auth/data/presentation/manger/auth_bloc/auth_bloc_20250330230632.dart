    ...
    on<AuthEvent>((event, emit) async {
      if (event is LoginEvent) {
        ...
        try {
          ...
          emit(LoginFailure(errorMessage: "Internal error: ${e.message}"));
        } on FirebaseAuthException catch (e) {
          print("❌ FirebaseAuthException: ${e.code} - ${e.message}");
          emit(LoginFailure(errorMessage: e.message ?? "Unknown error"));
        } catch (e) {
          print("❌ Unexpected Error: $e");
          emit(LoginFailure(errorMessage: "Something went wrong. Try again."));
        }
